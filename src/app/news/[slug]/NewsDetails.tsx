...
import { NewsItem } from "../constant/newsData";
import ProjectGallery from "../components/ProjectGallery";

interface NewsDetailClientProps {
  currentNews: NewsItem; // Use the imported type
}

export default function NewsDetailClient({ currentNews }: NewsDetailClientProps) {
    ...
    <>
      <div className="bg-gray-50 min-h-screen">
        ...
        {showGallery && selectedProjectId && (
          <ProjectGallery
            project={currentNews.projects?.find((p) => p.id === selectedProjectId)!}
