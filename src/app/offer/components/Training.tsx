  ...
  return (
    ...
    >
      <div
        ...
        }  lg:text-left lg:w-[50%] grid gap-5 transition duration-1000  `}
      >
        <div className="flex justify-between">
          <h2 className="text-3xl md:text-4xl  mb-6 text-gray-900/90 font-extrabold">
            Our
            <span className="text-blue-600"> Corporate</span> Trainings
          </h2>
        </div>
      ...
      >
        ...
        {/* <div className="absolute top-[25%] -left-[2rem] h-8 w-32 rounded-tl-[8rem] rounded-tr-[6rem] rounded-bl-[16rem] rounded-br-[2rem] z-20 bg-gradient-to-br bg-blue-500 animation-about"></div> */}
