...
import { Blocks, BookText, Brain, ShieldCheck, ArrowRight, Sparkles } from 'lucide-react'
  ...
  const courses = [
    {
      id: "lego-league",
      title: "LEGO League",
      description: "Dive into the world of robotics and innovation with LEGO bricks. Learn problem-solving, teamwork, and engineering principles.",
      icon: Blocks,
      link: "./steam/lego",
      bgColor: "bg-blue-50",
    ...
    },
    {
      id: "a-is-for-ai",
      title: "A is for AI",
      description: "Explore the fundamentals of Artificial Intelligence. Understand how AI works and its applications in the modern world.",
      icon: Brain,
      link: "./steam/ai",
      bgColor: "bg-blue-100",
    ...
    },
    {
      id: "jolly-phonics",
      title: "Jolly Phonics",
      description: "A fun and engaging program to master reading and writing skills through synthetic phonics. Perfect for young learners.",
      icon: BookText,
      link: "./steam/jolly",
      bgColor: "bg-blue-50",
      iconColor: "text-blue-700",
    ...
    },
    {
      ...
      description: "Learn essential skills to protect digital information and systems from cyber threats. Understand online safety and ethical hacking basics.",
      icon: ShieldCheck,
      link: "./steam/cybersec",
      bgColor: "bg-blue-100",
      iconColor: "text-blue-800",
      ...
      <main className="relative flex flex-col items-center justify-center max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="text-center mb-20 relative">
          <div className="inline-flex items-center px-4 py-2 bg-white/80 backdrop-blur-sm border border-blue-700 rounded-full text-sm text-blue-800 font-medium mb-8 shadow-sm">
            ...
            Igniting Young Minds Through STEAM Education
          </div>
          ...
          <p className="mt-6 text-xl sm:text-2xl max-w-4xl mx-auto text-gray-700 font-light leading-relaxed">
            Discover our meticulously designed steam that inspire curiosity and foster innovation across 
            <span className="font-semibold text-blue-800"> Science, Technology, Engineering, Arts, and Mathematics</span>.
          </p>
          
          <div className="mt-10 flex flex-wrap justify-center gap-4 text-sm">
            {['Interactive Learning', 'Expert Instructors', 'Hands-on Projects', 'Future-Ready Skills'].map((feature) => (
                ...
                <CardContent className="relative flex-grow px-8 pb-4">
                  ...
                  <div className="flex flex-wrap gap-2 mb-4">
                    {course.skills.map((skill) => (
                      <span key={skill} className="px-3 py-1 text-xs font-medium bg-white/80 text-blue-700 rounded-full border border-blue-700">
                        {skill}
                      </span>
                    ))}
                  </div>
...
>
  Explore Course
  <ArrowRight className={`w-4 h-4 transition-transform duration-300 ${hoveredCard === course.id ? 'translate-x-1' : ''}`} />
    </Link>
                </CardFooter>
              </Card>
            ))}
